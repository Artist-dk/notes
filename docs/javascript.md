# **🔥 Complete JavaScript Roadmap for Job Preparation 🚀**  
...
| | ✅ [Web APIs](https://github.com/Artist-dk/notes/blob/master/docs/javascript/JS031.md) | `Geolocation`, `Clipboard`, `Notification` APIs |
